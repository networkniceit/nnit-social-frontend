          ...
          <div key={client.id} style={styles.clientCard}>
            ...
            <div style={styles.stats}>
              <div style={styles.stat}>
                <span style={styles.statValue}>{client.stats?.totalPosts || 0}</span>
                <span style={styles.statLabel}>Posts</span>
              </div>
              <div style={styles.stat}>
                <span style={styles.statValue}>{client.stats?.scheduledPosts || 0}</span>
                <span style={styles.statLabel}>Scheduled</span>
              </div>
              <div style={styles.stat}>
                <span style={styles.statValue}>{client.stats?.totalEngagement || 0}</span>
...
const styles = {
  ...
  avatar: { width: '50px', height: '50px', borderRadius: '50%', background: 'linear-gradient(135deg, #667eea, #764ba2)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', fontWeight: '700' },
  clientInfo: { flex: 1 },
  ...
  stats: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '15px', marginBottom: '20px' },
  stat: { textAlign: 'center' },
  statValue: { display: 'block', fontSize: '24px', fontWeight: '700', color: '#667eea' },
  statLabel: { display: 'block', fontSize: '12px', color: '#718096' },
  manageButton: { width: '100%', padding: '10px', backgroundColor: '#f7fafc', border: '1px solid #e2e8f0', borderRadius: '6px', cursor: 'pointer', fontWeight: '500' },
  modalOverlay: { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 },
  modal: { backgroundColor: 'white', padding: '30px', borderRadius: '12px', maxWidth: '500px', width: '90%', maxHeight: '80vh', overflow: 'auto' },
  modalTitle: { fontSize: '24px', fontWeight: '700', marginBottom: '20px' },
  ...
  platformsSection: { marginTop: '10px' },
  label: { display: 'block', marginBottom: '10px', fontWeight: '500' },
  platformButtons: { display: 'flex', flexWrap: 'wrap', gap: '10px' },
  platformButton: { padding: '8px 16px', border: '1px solid #e2e8f0', borderRadius: '6px', backgroundColor: 'white', cursor: 'pointer', textTransform: 'capitalize' },
  platformButtonActive: { backgroundColor: '#667eea', color: 'white', borderColor: '#667eea' },
